...
public class ShoppingCartController {
    ...
    public ShoppingCart getById(@PathVariable @Min(value = 1 , message="The required request parameter idShoppingCart is negative our missing.") Integer idShoppingCart) {
        return shoppingCartService.getById(idShoppingCart);
    }

    @Operation(summary = "Register a new shopping cart")
    @PostMapping()
    public ResponseEntity<String> add(@Valid @RequestBody ShoppingCart resource) {
    ...
    public ResponseEntity<String> update(@Valid @RequestBody ShoppingCart resource, @PathVariable @Min(value = 1 , message="The required request parameter idShoppingCart is negative our missing.") Integer idShoppingCart) {
    ...
    public ResponseEntity<String> delete(@PathVariable @Min(value = 1 , message="The required request parameter idShoppingCart is negative our missing.") Integer idShoppingCart) {
